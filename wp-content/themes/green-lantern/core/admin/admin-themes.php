<?php if (!function_exists('greenlantern_info_page')) {
	...
	$page1=add_theme_page(__('Welcome to Green-Lantern', 'green-lantern'), __('Pro Themes & Plugin', 'green-lantern'), 'edit_theme_options', 'green-lantern', 'greenlantern_display_theme_info_page');
...
function weblizar_admin_info(){
	...
	//JS
	wp_enqueue_script('bootstrap-js', get_template_directory_uri().'/js/menu/bootstrap.js');
...
<div class="container-fluid space p_front plugin">
	...
	<div id="theme-author">
		<p><?php printf(__('%1s is proudly brought to you by %2s. If you like this WordPress theme, %3s.', 'green-lantern'),
			$theme_data->Name,
			'<a target="_blank" href="https://weblizar.com/" title="weblizar">Weblizar</a>',
			'<a target="_blank" href="https://wordpress.org/support/view/theme-reviews/green-lantern" title="Green-Lantern Review">' . __('rate it', 'green-lantern') . '</a>'); ?>
		</p>
	</div>
</div>
<?php
